<?php
    ...
    try {
        ...
        //Recipients
        $mail->setFrom('wavvbeats@gmail.com', 'Remetente');
        ...
        $mail->AltBody = 'Seu e-mail não suporta html, utilize outro.';
        ...
        $mensagem->status['descricao_status'] = 'Não foi possível enviar este e-mail, tente novamente mais tarde. Erro: ' . $mail->ErrorInfo;
            ...
            <div class="row">
                <div class="col-md-12">
                    ...
                    <?php if($mensagem->status['codigo_status'] == 2) { ?>
                        ...
                        <div class="container">
                            <div class='display-4 text-danger'>Ops!</div>
                            <p> <?= $mensagem->status['descricao_status']?> </p>
                            <a href="index.php" class='btn btn-success btn-lg mt-5 text-white'>Voltar</a>
                        </div>
